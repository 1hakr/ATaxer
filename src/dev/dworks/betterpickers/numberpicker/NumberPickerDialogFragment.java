...
public class NumberPickerDialogFragment extends DialogFragment {
    ...
    private static final String SET_NUMBER_KEY = "NumberPickerDialogFragment_SetNumberKey";
    ...
    private static final String MAX_VISIBILITY_KEY = "NumberPickerDialogFragment_MaxVisibilityKey";
    ...
    public static NumberPickerDialogFragment newInstance(int reference, int themeResId, Integer minNumber,
        ...
        if (maxVisibility != null) {
            args.putInt(MAX_VISIBILITY_KEY, maxVisibility);
        }
        if (labelText != null) {
    ...
    public static NumberPickerDialogFragment newInstance(int reference, int themeResId, Integer minNumber,
            Integer maxNumber, Integer plusMinusVisibility, Integer decimalVisibility, Integer maxVisibility, String labelText, String setNumber) {
        final NumberPickerDialogFragment frag = new NumberPickerDialogFragment();
        Bundle args = new Bundle();
        args.putInt(REFERENCE_KEY, reference);
        args.putInt(THEME_RES_ID_KEY, themeResId);
        ...
        if (setNumber != null) {
            args.putString(SET_NUMBER_KEY, setNumber);
        }
        frag.setArguments(args);
        return frag;
    }
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (args != null && args.containsKey(MAX_VISIBILITY_KEY)) {
            mMaxVisibility = args.getInt(MAX_VISIBILITY_KEY);
        }
        ...
        if (args != null && args.containsKey(SET_NUMBER_KEY)) {
        	mSetNumber = args.getString(SET_NUMBER_KEY);
        }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if(null != mMaxVisibility){
        	mPicker.setMaxVisibility(mMaxVisibility);
        }
        mPicker.setNumber(mSetNumber);
    ...
    public interface NumberPickerDialogHandler {
        ...
        void onDialogNumberSet(int reference, long number, double decimal, boolean isNegative, double fullNumber);
    }
}